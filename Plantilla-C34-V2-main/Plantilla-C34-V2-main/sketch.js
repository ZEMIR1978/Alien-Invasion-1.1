...
towerImage = loadImage("piramide.png");
...
function setup() {
  ...
  tower = Bodies.rectangle(160, 350, 500,500, { isStatic: true });
  ...
  turret = new Turret (180, 350, 100, 50, angle);
  ...
  if (aliens.length > 0) {
    ...
    for (var i = 0; i < aliens.length; i++) {
      ...
      if (collision.collided && !aliens[i].isBroken) {
        ...
        var alien = new Alien(width, height - 60, 170, 170, -60, alienAnimation);
        aliens.push(alien);
      }
